...
This plugin provides a 9-step interactive research workflow:
...
6. Report planned experiments to user
7. Confirm fail-fast agreement
8. Execute experiments in lambda order
9. Compile LaTeX research paper
